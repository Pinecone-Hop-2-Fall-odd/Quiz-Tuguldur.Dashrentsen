    ...
    <div class="relative items-center  bg-white w-screen h-screen flex justify-center">
      ...
      <div className="items-center absolute bottom-[26.30179028132992vh] flex gap-[0.8525149190110827vh] flex-col">
        ...
        <Link href="./CategoriesHome">
          <button className="active:bg-sky-900 w-[17.857142857142858vw] h-[8.525149190110827vh] text-white bg-[#1A8BBB] text-[60px] font-medium" style={{borderRadius: "25px"}}>
            Play
          </button>
        </Link>
        <Link href="./CustomQuizMenu">
          <button className="active:bg-sky-900 w-[26.785714285714285vw] h-[8.525149190110827vh] text-white bg-[#1A8BBB] text-[60px] font-medium" style={{borderRadius: "25px"}}>
            Custom Quiz Play
          </button>
        </Link>
      </div>
